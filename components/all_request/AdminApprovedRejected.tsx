...
import { AdminComplitedAction } from "./AdminComplitedAction";
// import { ComplitedAction } from "./ComplitedAction";
interface User {
  name: string;
}
...
export function AdminApprovedRejected({ requests }: RequestsTableProps) {
    ...
    <SelectValue placeholder="Filter by category" />
      ...
      {filteredRequests?.length ? (
        ...
        <div className="flex flex-col items-center justify-center p-6 border-t bg-white shadow-sm w-full space-y-3 text-center">
          ...
          <div className="text-lg font-semibold text-gray-800">All caught up!</div>
